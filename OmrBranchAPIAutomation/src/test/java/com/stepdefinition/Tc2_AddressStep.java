...
public class Tc2_AddressStep extends BaseClass{
	...
	public void userSendPOSTRequestForAddaddressEndpoint() {
		response = requestType("POST", Endpoint.ADDADDDRESS);
	}
	...
	@When("User add the payload{string}, {string},{string},{string},{string},{string},{string},{string},{string},{string},{string} for updating the address with address_Id")
	public void userAddThePayloadForUpdatingTheAddressWithAddress_Id(String string, String string2, String string3,
		...
		UpdateAddress_Input_Pojo input = new UpdateAddress_Input_Pojo(string, string2, string3, string4, string5,
				Integer.parseInt(string6), Integer.parseInt(string7), Integer.parseInt(string8), string9, string10,
				string11);
	...
	public void userAddHeadersForDeleteAddress() {
		List<Header> l = new ArrayList<>();
		Header h = new Header("accept", "application/json");
		Header h1 = new Header("Authorization", "Bearer " + Tc1_LoginStep.logtoken);
		Header h2 = new Header("Content-Type", "application/json");
	...
	public void userAddThePayloadForDeletingTheAddressWith(String string) {
		DeleteAddress_Input_Pojo del = new DeleteAddress_Input_Pojo(string);
		System.out.println(string);
		addBody(del);
	}
